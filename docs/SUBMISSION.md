...
Contest hard cap is **5:00**. Aim for **4:45 spoken** to leave headroom.
Talk fast but clear. Every beat is one breath.
...
- Record at 1080p, 30 fps, system audio + mic. Final file ≤ 5:00.
